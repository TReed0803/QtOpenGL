...
public:
  ...
  GL_PROFILE(OpenGLShaderProgramChecked,attributeLocation,const char *) const
  GL_PROFILE(OpenGLShaderProgramChecked,attributeLocation,const QByteArray &) const
  GL_PROFILE(OpenGLShaderProgramChecked,attributeLocation,const QString &) const
