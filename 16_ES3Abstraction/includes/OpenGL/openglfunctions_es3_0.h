...
public:
  ...
  GL_PROFILE(QOpenGLFunctions_ES3_0,glClearDepthf, GLclampf depth)
  ...
  GL_PROFILE(QOpenGLFunctions_ES3_0,glCreateProgram, void)
  ...
  GL_PROFILE(QOpenGLFunctions_ES3_0,glDrawArrays, GLenum, GLint first, GLsizei)
  ...
  GL_PROFILE(QOpenGLFunctions_ES3_0,glReleaseShaderCompiler, void)
  ...
  GL_PROFILE(QOpenGLFunctions_ES3_0,glVertexAttrib1fv, GLuint, const GLfloat* values)
  GL_PROFILE(QOpenGLFunctions_ES3_0,glVertexAttrib2f, GLuint, GLfloat, GLfloat)
  GL_PROFILE(QOpenGLFunctions_ES3_0,glVertexAttrib2fv, GLuint, const GLfloat* values)
  GL_PROFILE(QOpenGLFunctions_ES3_0,glVertexAttrib3f, GLuint, GLfloat, GLfloat, GLfloat)
  GL_PROFILE(QOpenGLFunctions_ES3_0,glVertexAttrib3fv, GLuint, const GLfloat* values)
  GL_PROFILE(QOpenGLFunctions_ES3_0,glVertexAttrib4f, GLuint, GLfloat, GLfloat, GLfloat, GLfloat)
  GL_PROFILE(QOpenGLFunctions_ES3_0,glVertexAttrib4fv, GLuint, const GLfloat* values)
  ...
  GL_PROFILE(QOpenGLFunctions_ES3_0,glDrawRangeElements, GLenumd, GLuintd, GLuint, GLsizei, GLenum, const void *)
  GL_PROFILE(QOpenGLFunctions_ES3_0,glTexImage3D, GLenum, GLint, GLintd, GLsizeid, GLsizei, GLsizei, GLint, GLenum, GLenum, const void *)
  GL_PROFILE(QOpenGLFunctions_ES3_0,glTexSubImage3D, GLenum, GLint, GLint, GLint, GLintd, GLsizeid, GLsizei, GLsizei, GLenum, GLenum, const void *)
  GL_PROFILE(QOpenGLFunctions_ES3_0,glCopyTexSubImage3D, GLenum, GLint, GLint, GLint, GLintd, GLint, GLint, GLsizeid, GLsizei)
  GL_PROFILE(QOpenGLFunctions_ES3_0,glCompressedTexImage3D, GLenum, GLint, GLenumd, GLsizeid, GLsizei, GLsizei, GLint, GLsizei, const void * )
  GL_PROFILE(QOpenGLFunctions_ES3_0,glCompressedTexSubImage3D, GLenum, GLint, GLint, GLint, GLintd, GLsizeid, GLsizei, GLsizei, GLenum, GLsizei, const void *)
  ...
  GL_PROFILE(QOpenGLFunctions_ES3_0,glRenderbufferStorageMultisample, GLenum, GLsizei, GLenumd, GLsizeid, GLsizei)
  GL_PROFILE(QOpenGLFunctions_ES3_0,glFramebufferTextureLayer, GLenum, GLenum, GLuintd, GLint, GLint)
  ...
  GL_PROFILE(QOpenGLFunctions_ES3_0,glGetTransformFeedbackVarying, GLuint, GLuint, GLsizei, GLsizei *, GLsizei *size, GLenum *, GLchar *)
  ...
  GL_PROFILE(QOpenGLFunctions_ES3_0,glClearBufferfi, GLenum, GLint, GLfloat, GLint stencil)
  ...
  GL_PROFILE(QOpenGLFunctions_ES3_0,glGetUniformIndices, GLuint, GLsizei, const GLchar *const*uniformNames, GLuint *)
  ...
  GL_PROFILE(QOpenGLFunctions_ES3_0,glUniformBlockBinding, GLuint, GLuint, GLuint uniformBlockBinding)
  GL_PROFILE(QOpenGLFunctions_ES3_0,glDrawArraysInstanced, GLenumd, GLint, GLsizei, GLsizei)
  GL_PROFILE(QOpenGLFunctions_ES3_0,glDrawElementsInstanced, GLenumd, GLsizei, GLenum, const void *, GLsizei)
  ...
  GL_PROFILE(QOpenGLFunctions_ES3_0,glBindSampler, GLuint unit, GLuint)
  ...
  GL_PROFILE(QOpenGLFunctions_ES3_0,glInvalidateSubFramebuffer, GLenum, GLsizei, const GLenum *, GLint, GLint, GLsizeid, GLsizei)
  GL_PROFILE(QOpenGLFunctions_ES3_0,glTexStorage2D, GLenum, GLsizei, GLenumd, GLsizeid, GLsizei)
  GL_PROFILE(QOpenGLFunctions_ES3_0,glTexStorage3D, GLenum, GLsizei, GLenumd, GLsizeid, GLsizei, GLsizei)
  GL_PROFILE(QOpenGLFunctions_ES3_0,glGetInternalformativ, GLenum, GLenumd, GLenum, GLsizei, GLint *)
