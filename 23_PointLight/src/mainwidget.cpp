...
void MainWidget::initializeGL()
{
  ...
  // Application-specific initialization
  {
    ...
    p.m_pointLightProgram->addIncludePath(":/shaders");
    p.m_pointLightProgram->addShaderFromSourceFile(QOpenGLShader::Vertex, ":/shaders/lighting/pointLight.vert");
    p.m_pointLightProgram->addShaderFromSourceFile(QOpenGLShader::Fragment, ":/shaders/lighting/pointLight.frag");
    ...
    char const* fragFiles[DeferredDataCount] = {
      ...
      ":/shaders/gbuffer/ambient.frag",
      ":/shaders/gbuffer/motion.frag",
      ":/shaders/gbuffer/backbuffer.frag"
    };
    ...
    KHalfEdgeMesh *mesh1 = new KHalfEdgeMesh(this, ":/pointLight.obj");
    ...
    KHalfEdgeMesh *mesh = new KHalfEdgeMesh(this, ":/floor.obj");
